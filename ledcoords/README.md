...
## Example
If you have a 64x32 board, copy `w64h32.json.defaults` to a new file called `w64h32.json`, then edit the coordinates in that file as you see fit. Your customized coordinates will always take precedence.
